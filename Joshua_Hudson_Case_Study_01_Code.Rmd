...
```{r}
bb_clean = bb %>% filter(!is.na(ABV) & !is.na(IBU) & !is.na(Style))
...
abv_ibu_cat %>% ggplot(mapping = aes(x = IBU, y = ABV)) + geom_point(position = "jitter") + geom_smooth()
